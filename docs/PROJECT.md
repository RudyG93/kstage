...
**Chiffres prod** : 112 groupes (31 solistes), ~1 070 MVs propres, **544 tests unitaires + 28 E2E** (⚠️ job e2e GitHub encore « skipped » — vérifier que E2E_ENABLED=true est une Variable, pas un Secret). App : https://kstage.vercel.app/
