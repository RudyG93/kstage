...
**Chiffres prod** : 112 groupes (31 solistes), ~949 MVs propres, **523 tests unitaires + 27 E2E** (job e2e gated `E2E_ENABLED`, variable pas encore posée — action Rudy). App : https://kstage.vercel.app/
