...
**Chiffres prod** : **150 groupes** (31 solistes + 38 debuts auto-créés le 13/07), **2 278 MVs** (catalogues pleine profondeur + pliage d'accents — BTS 63, SEVENTEEN 60, TWICE 42, Rosé 6 dont APT.), 100 bannières YT 2560px, 172 photos membres à l'ère courante, **544 tests unitaires + 28 E2E** (⚠️ job e2e GitHub encore « skipped » — vérifier que E2E_ENABLED=true est une Variable, pas un Secret). App : https://kstage.vercel.app/
