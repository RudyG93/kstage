...
**Chiffres prod** : **168 groupes** (33 solistes + debuts auto + 14 ajoutés R10 : RESCENE/PLAVE/UNIS/NEXZ…), **2 355 MVs** (catalogues pleine profondeur + 65 R11 via chaînes label), **819 membres dont 809 avec photo** (98,8 %), bannières YT 2560px, **544 tests unitaires + 28 E2E** (⚠️ job e2e GitHub encore « skipped » — vérifier que E2E_ENABLED est une **Variable Actions au niveau repo**, pas un Secret ni une Environment). **Socle scraping activé** (R10.1) : crons GitHub Actions opérationnels (music-shows 2×/j, youtube, comebacks, images). App : https://kstage.vercel.app/
