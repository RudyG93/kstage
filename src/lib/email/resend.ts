...
function welcomeHtml(username: string | null): string {
  ...
  return `<!doctype html>
<html lang="en">
  <body style="margin:0;background:#0e0e13;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;color:#e7e7ea;">
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#0e0e13;padding:32px 16px;">
      <tr><td align="center">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;background:#16161d;border-radius:16px;overflow:hidden;border:1px solid #26262f;">
          <tr><td style="padding:28px 28px 8px;">
            <div style="font-size:22px;font-weight:800;background:linear-gradient(90deg,#8b5cff,#ff2d87);-webkit-background-clip:text;background-clip:text;color:#ff2d87;">KStage</div>
          </td></tr>
          ...
          <tr><td style="padding:8px 28px 28px;">
            <a href="${SITE_URL}/" style="display:inline-block;background:linear-gradient(90deg,#8b5cff,#ff2d87);color:#fff;text-decoration:none;font-weight:600;font-size:14px;padding:10px 20px;border-radius:10px;">Open KStage</a>
          </td></tr>
        </table>
