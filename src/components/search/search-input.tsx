...
export function SearchInput() {
  ...
  return (
    ...
    <div className="focus-within:border-primary/50 focus-within:ring-primary/15 bg-secondary flex h-10 items-center gap-2 rounded-lg border px-3 transition-shadow focus-within:ring-2">
