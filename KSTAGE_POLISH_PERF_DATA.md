...
- **RESTE À FAIRE** : §5 images membres (kpopping via proxy Jina, fallback initiales en dernier recours) — gros pipeline, décision Storage vs URL externe à trancher ; élargissement scope §4.3 (seed chaînes non-MVP).
